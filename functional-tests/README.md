# PyACT-R demo functional tests

Create and Run ACT-R cognitive models

This is a functional test suite based on [pytest][1] and [Selenium WebDriver][2]. It is designed such that it can test any network-reachable instance of the PyACT-R demo application. While the tests are based on knowledge about the user interface of the application, no knowledge of its implementation is needed.
...
Every test in this suite is a short, automated simulation of the interaction between a user and PyACT-R demo, written in Python. [Selenium][2] provides the programmable web browser interface while [pytest][1] provides administrative support in the form of configuration and fixtures.
...
$ pytest --base-address https://www.pyactr_demo.com/app/
```
