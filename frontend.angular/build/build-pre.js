...
async function getRemoteUrl() {
    return new Promise((resolve, reject) => {
        exec('git config --get remote.origin.url', (error, stdout, stderr) => {
            ...
            // format is either:
            // git@github.com:CentreForDigitalHumanities/pyactr_demo.git
            // or https://github.com/CentreForDigitalHumanities/pyactr_demo.git
            // or https://USERNAME:SECRET@github.com/CentreForDigitalHumanities/pyactr_demo.git/
